...
* \subsubtitle{Estudiantes}
    - \subsubtitleB{Conocimientos previos.}
    - \subsubtitleB{Experiencia profesional.}
    \pause
* \subsubtitle{Profesor:}
    ...
    \centering
        ...
        \vspace{4mm}
        \subsubtitleB{Ingeniero Civil en Computación}\\
        \subsubtitleB{Universidad de Chile}
    \end{customRoundedBox}
    
    \hspace{60mm}\begin{customRoundedBox}{}
    \centering
        \subsubtitleB{nozimica@dcc.uchile.cl}\\
        \subsubtitleB{nozimica@gmail.com}
    \end{customRoundedBox}
    \end{center}
...
\draw[->,thick] (a2) -- (a1)
  node[midway,above=1mm] {{\scriptsize vive en}};
\draw[->,thick] (a2) -- (a3)
  node[midway,above=1mm] {{\scriptsize trabaja en}};
\end{tikzpicture}
...
\node (c1) [methods, left=18mm of truck, text width=25mm] {Encender};
\node (c2) [methods, right=18mm of truck, text width=25mm] {Prender motor de arranque};

...
\begin{itemize}
    \item Sistema            \tikz[inlineBlock] \coordinate (jds1) ;
    \item Juego de dos dados \tikz[inlineBlock] \coordinate (jds2) ;
    \item Dados              \tikz[inlineBlock] \coordinate (jds3) ;
    \item Primer dado        \tikz[inlineBlock] \coordinate (jds4) ;
    \item Segundo dado       \tikz[inlineBlock] \coordinate (jds5) ;
    \item Resultado          \tikz[inlineBlock] \coordinate (jds6) ;
    \item Lanzamiento        \tikz[inlineBlock] \coordinate (jds7) ;
    \item Jugador            \tikz[inlineBlock] \coordinate (jds8) ;
    \item Usuario            \tikz[inlineBlock] \coordinate (jds9) ;
    \item Interfaz gráfica   \tikz[inlineBlock] \coordinate (jds10);
\end{itemize}
